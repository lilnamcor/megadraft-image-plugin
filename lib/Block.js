  ...
  _createClass(Block, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.state.ipfsConnected && !prevState.ipfsConnected) {
        (0, _ipfsHelper.getFiles)(this.props.data.imageHash, this.node).then(function (blobUrl) {
          _this3.setState({
            blobUrl: blobUrl
          });
        });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.data.imageHash && this.state.blobUrl ? _react2.default.createElement(
          "div",
          { className: "block" },
